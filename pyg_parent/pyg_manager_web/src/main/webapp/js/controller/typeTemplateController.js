...
app.controller('typeTemplateController' ,function($scope,$controller,typeTemplateService,brandService,specificationService){
	...
	$scope.findOne=function(id){				
		typeTemplateService.findOne(id).success(
			function(response){
				...
				$scope.entity.brandIds = JSON.parse($scope.entity.brandIds); //将字符串转换成json格式
	...
	//关联商品
	$scope.findByList = function () {
		brandService.findByList().success(
			function (response) {
    ...
    //关联规格
    $scope.findBySpecList = function () {
        specificationService.findBySpecList().success(
            function (response) {
